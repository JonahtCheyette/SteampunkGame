...
class Move {
	public:
        ...
        void movePlayer(Object::Player &a, SDL_Event& e, Level l, Object::Camera c, std::vector<std::vector<float>> tileGrid);
		void moveHook(Object::Player &a);
        void grapple(Object:: Player &a, Object::Point b, std::vector<std::vector<float>> tileGrid, Object::Camera c);
